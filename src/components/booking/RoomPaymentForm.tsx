    ...
    try {
      ...
      if (overlapFound) {
        ...
        return toast({
          variant: "destructive",
          description:
            "Oops! Some of the days you are trying to book have already been reserved. Please Select some different dates or rooms.",
        });
      }
    ...
    <form onSubmit={handleSubmit} id="payment-form">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-1 mb-2">
          <h1 className="font-semibold mb-2 mt-4 text-lg">
          ...
          {bookingRoomData?.breakFastIncluded && (
            <div>You will be served with breakfast eachdat at 8 AM</div>
          )}
        </div>
        <Separator />
