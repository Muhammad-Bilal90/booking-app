...
const AddHotelForm = ({ hotel }: AddHotelFormProps) => {
  ...
  const handleDeleteHotel = async (hotel: HotelWithRooms) => {
    ...
    try {
      ...
      setIsHotelDeleting(false);
      console.log("Hotel not deleted:", error);
    }
  };
            ...
            <div className="flex-1 flex flex-col gap-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        In which country is our property located
                      </FormDescription>
                      <Select
                        disabled={isLoading}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        In which state is our property located
                      </FormDescription>
                      <Select
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      In which city is our property located
                    </FormDescription>
                    <Select
              ...
              {hotel && !hotel.rooms.length && (
                <Alert className="bg-indigo-600 text-white">
                  ...
                  <AlertDescription>
                    Your hotel was added successfully 🔥
                    <div>
